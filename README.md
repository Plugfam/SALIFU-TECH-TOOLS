...
<body>
    ...
    <div class="container">
        <div class="title">PLUGFAM 𝗛4𝗫 𝗕𝗜𝗢</div>

        <img src="https://i.ibb.co/DG1fffY/IMG-20241231-WA0393-3.jpg" alt="Profile Picture">
        
        <h1><a href="https://t.me/BJ_Coder">PLUG 𝗛4𝗫</a></h1>

        <div class="inline-details">
            <div class="place">𝗣𝗜𝗔𝗖𝗘 : Ghana</div>
            <div>𝗔𝗚𝗘 → 20+</div>
            <div class="best-friend"><a href="">𝗕𝗘𝗦𝗧 𝗙𝗥𝗜𝗘𝗡𝗗 →NO FRIEND 🗿</a></div>
        </div>
        ...
        <div class="section">
            ...
            <ul>
                <li>PAINTER</li>
                <li>GRAPHIX DESIGN</li>
                <li>ARTIST</li>
                <li>PHONE REPAIRER</li>
                <li>BOT HOSTER</li>
                <li>ᴇᴛᴄ</li>
            </ul>
        </div>
        ...
        <div class="section admins">
            <h2>WHATSAPP AND GROUP</h2>
            <ul>
                <li><a href="https://wa.me/qr/5FQWSK7V25RVB1">PERSONAL WHATSAPP</a></li>
                <li><a href="https://chat.whatsapp.com/HkAVfXUe0sZKBiMm7fB0GN">MY TECH GROUP</a></li>
